...
def process_text_with_chatgpt(text, api_key=None, model="gpt-4o"):
    ...
    - Каждую отдельную мысль размещай на отдельной строке, но без пустых строк между строками если это не обзац.  
    - Если мысль сложная, использую списки
    - заголовки и подзаголовки используй не слишком часто но и не слишком редко  - 1-3 обзаца на заголовок. Лучше это по смыслу текста.
    - Перечисления и примеры оформляй в лаконичные списки.
